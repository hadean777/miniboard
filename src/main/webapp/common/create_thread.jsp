...
<div class="form-group">
		<label for="threadname">Name:</label>
  		<input class="form-control" id="threadname" type="text"></input>
  		<label for="message1">Message:</label>
  		<textarea class="form-control" rows="15" id="message1"></textarea>
  		<button type="button" class="btn btn-default" onclick="createThread()" style="margin: 10px">Create New Thread</button><br>
